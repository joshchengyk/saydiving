                    ...
                    <b-navbar toggleable="lg" >
                        ...
                        <b-navbar-nav class="ml-auto">
                            ...
                            <b-nav-item-dropdown v-if='getuserjwt' right class='mt8' >
                                ...
                                <b-dropdown-item href=""><nuxt-link to='/users/my-lessons'> 我的帳號</nuxt-link></b-dropdown-item>
                            ...
                            <b-nav-item><nuxt-link class="btn btnnew" to='/lessons'>馬上報名</nuxt-link></b-nav-item>
                        </b-navbar-nav>
                        </b-collapse>
                    </b-navbar>
                </div>
